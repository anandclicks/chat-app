    ...
    <>
      {msgData?.images?.length >= 1 && (
        <div className='sendMsgWrapper h-[200px] w-full flex justify-start items-center mb-2'>
          <div className='bg-steal-500 max-w-[250px] min-w-[250px] shadow relative text-white text-sm h-full flex justify-center items-center rounded-3xl overflow-hidden'>
